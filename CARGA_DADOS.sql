...
/* OS */
INSERT INTO OS 
VALUES (1,TO_DATE('01/05/2019','DD,MM,YY'),'Problema1','MANUTENCAO',TO_DATE('02/05/2019','DD,MM,YY'),TO_DATE('03/05/2019','DD,MM,YY'),
'MANUTENCAO PREVENTIVA','1.pdf',500.00,1,1);
INSERT INTO OS 
VALUES (2,TO_DATE('10/05/2019','DD,MM,YY'),'Problema2','MANUTENCAO',TO_DATE('11/05/2019','DD,MM,YY'),TO_DATE('12/05/2019','DD,MM,YY'),
'MANUTENCAO CORRETIVA','2.pdf',300.00,2,2);
INSERT INTO OS 
VALUES (3,TO_DATE('15/05/2019','DD,MM,YY'),'Problema3','MANUTENCAO',TO_DATE('16/05/2019','DD,MM,YY'),TO_DATE('17/05/2019','DD,MM,YY'),
'MANUTENCAO PREVENTIVA','3.pdf',400.00,2,1);
INSERT INTO OS 
VALUES (4,TO_DATE('20/05/2019','DD,MM,YY'),'Problema4','MANUTENCAO',TO_DATE('21/05/2019','DD,MM,YY'),TO_DATE('22/05/2019','DD,MM,YY'),
'MANUTENCAO CORRETIVA','4.pdf',200.00,1,2);

/* POSSUI VINCULO */
INSERT INTO Possui_Vinculo VALUES (1,2);
INSERT INTO Possui_Vinculo VALUES (3,4);
INSERT INTO Possui_Vinculo VALUES (5,6);

/* PERTENCE */
INSERT INTO Pertence VALUES (1,1);
INSERT INTO Pertence VALUES (2,2);
INSERT INTO Pertence VALUES (3,3);
INSERT INTO Pertence VALUES (4,4);
INSERT INTO Pertence VALUES (5,5);